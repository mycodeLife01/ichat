...
// ChatGPT sidebar panel mark, using the reference interface's 20px paths.
function sidebarToggleIcon({ size = 20, ...props }: CustomIconProps) {
  return (
    ...
    >
      <path
        d="M3.3335 5.33333C3.3335 4.22876 4.22893 3.33333 5.3335 3.33333H14.6668C15.7714 3.33333 16.6668 4.22876 16.6668 5.33333V14.6667C16.6668 15.7712 15.7714 16.6667 14.6668 16.6667H5.3335C4.22893 16.6667 3.3335 15.7712 3.3335 14.6667V5.33333Z"
        stroke="currentColor"
        strokeWidth="1.33333"
      />
      <path
        d="M7.3335 3.66667V16.3333"
        stroke="currentColor"
        strokeWidth="1.33333"
      />
    </svg>
