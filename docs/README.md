...
| Adding, editing, enabling, disabling, archiving/restoring, routing, or rolling back chat models/upstreams; model-management Web access; reasoning output/continuation behavior | `docs/handover/2026-09-25-model-catalog-archive.md` + `docs/plans/2026-09-12-model-admin-archive-and-layout.md` + `docs/handover/2026-08-31-provider-continuation-route-affinity.md` + `docs/handover/2026-08-29-database-model-catalog.md` + ADRs `0012-use-database-model-routes-and-code-adapters.md`, `0013-scope-provider-continuations-by-route-affinity.md`, and `0014-archive-catalog-rows-instead-of-hard-delete.md` + `docs/deployment.md` + `docs/architecture/frontend.md` |
